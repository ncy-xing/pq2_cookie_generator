...
The Ingredients class models an ingredient as an ingredient name, amount, 
and unit. 
"""


class Ingredient:
    def __init__(self, ing_name: str,
                 ing_amount: int | float, ing_unit: str) -> None:
    ...
    def __eq__(self, other: object) -> bool:
        """Compare two sets of ingredients. Ingredients are the same 
        if they have the same name, amount, and unit."""
